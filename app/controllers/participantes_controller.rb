class ParticipantesController < ApplicationController
  ...
  private
    ...
    def participante_params
      params.require(:participante).permit(:ci, :nombre, :apellidoP, :apellidoM, :numWpp, :numFijo, :direccion, :fecNacimiento, :latitud, :longitud, :nit, :empresa, :teloficina, :rubro, :email, :cargo, :sexo, :nacionalidad, :professor, :categoria, :ciudad, :pais, :sitioweb, :facebook, :skype, :twitter, :linkedin, :medioatecion, :faseCRM, :responsable, :observaciones, :email, :password, :estado, :foto)
    end
end
